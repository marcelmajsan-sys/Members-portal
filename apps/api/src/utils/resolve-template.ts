...
export const DEFAULT_TEMPLATES: Array<{
  ...
  },
  {
    ...
    subject: 'Vaše članstvo ističe {{datum_isteka}} — eCommerce Hrvatska',
    body: 'Podsjećamo Vas da Vaše članstvo u udruzi eCommerce Hrvatska ističe {{datum_isteka}} — za manje od 14 dana.\n\nObnovite članstvo na vrijeme kako biste bez prekida zadržali pristup pogodnostima, događajima i alatima za članove.\n\nAko ste ponudu već zaprimili ili uplatili, slobodno zanemarite ovaj podsjetnik.',
    ctaLabel: undefined,
    ctaUrl: undefined,
  },
  {
    ...
    body: 'Ovo je zadnji podsjetnik: Vaše članstvo u udruzi eCommerce Hrvatska ističe {{datum_isteka}}.\n\nNakon tog datuma članstvo prelazi u status isteklog i gubite pristup pogodnostima za članove. Obnovite članstvo što prije — ako ste uplatu već izvršili, slobodno zanemarite ovu poruku.',
    ctaLabel: undefined,
    ctaUrl: undefined,
  },
  {
